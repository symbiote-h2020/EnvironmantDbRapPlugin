...
public class EnvironmantDbRapPluginApplication implements CommandLineRunner {
    ...
    // Property IRI: https://github.com/symbiote-h2020/SymbioteCloud/blob/master/resources/docs/property_uris
    // Unit IRI: https://github.com/symbiote-h2020/Ontologies/blob/master/v2.3.0/bim-qu-align-v2.3.0.ttl
	private ObservationValue getObservationValueForTemperature(SensorReading reading) {
        return new ObservationValue(
            reading.getTemperature(), 
            new Property("temperature", "http://purl.oclc.org/NET/ssnx/qu/quantity#temperature", Arrays.asList("Air temperature")), 
	...
	private ObservationValue getObservationValueForCO(SensorReading reading) {
		return new ObservationValue(
				reading.getCo(), 
				new Property("carbonMonoxideConcentration", "http://www.symbiote-h2020.eu/ontology/bim/property#carbonMonoxideConcentration", Arrays.asList("Air carbon monoxide concentration")), 
				new UnitOfMeasurement("ug/m3", "microgram per cubic metre", "http://purl.oclc.org/NET/ssnx/qu/unit#microgramPerCubicMetre", null));
	}    
	...
	private ObservationValue getObservationValueForPressure(SensorReading reading) {
		return new ObservationValue(
				reading.getPressure(), 
				new Property("atmosphericPressure", "http://purl.oclc.org/NET/ssnx/qu/quantity#atmosphericPressure", Arrays.asList("Air hydrostatic pressure")), 
	...
	private ObservationValue getObservationValueForSO2(SensorReading reading) {
		return new ObservationValue(
				reading.getSo2(), 
				new Property("sulphurDioxideConcentration", "http://www.symbiote-h2020.eu/ontology/bim/property#sulphurDioxideConcentration", Arrays.asList("Air sulphur dioxide concentration")), 
				new UnitOfMeasurement("ug/m3", "microgram per cubic metre", "http://purl.oclc.org/NET/ssnx/qu/unit#microgramPerCubicMetre", null));
	}    
